...
/*export const Cuisines = [
  Asian = [
    {
      ...
      id : 1, 
      ingredients : {
        i: '2 (5.6-ounce) packages refrigerated Yaki-Soba, seasoning sauce packets discarded',
        ii:' 1 tablespoon cornstarch',
        iii: '1/3 cup reduced sodium soy sauce',
        iv:'1/4 cup brown sugar, packed',
        v:'3 cloves garlic, minced',
        vi:'1 tablespoon freshly grated ginger',
        vii:'2 tablespoons honey',
        viii:'1 pound boneless, skinless chicken thighs, cut into 1-inch chunks',
        ix:'1 tablespoon olive oil',
        x:'1 teaspoon sesame seeds',
        xi:'1 green onion, thinly sliced'
      },
  ...
  {
      img : URL('../image/asian-garlic-noodles.jpg'),
  ...
  {
      img : URL('../image/shrimp-broccoli-stirfry'),
